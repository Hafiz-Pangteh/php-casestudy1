...
if(isset($_POST['add'])){
    ...
    $_SESSION['DeliveryBy--4'] = $DeliveredBy;
    $_SESSION['ItemNo--4'] = $ItemNo;
    $_SESSION['InputTime--4'] = $InputTime;
    $_SESSION['InputTime2--4'] = $InputTime2;
...
//display total item quantity
    ...
    for($x=0; $x<5; $x++){
     if($_SESSION['DeliveryBy--4'][$x]!=""){
        ...
        echo "<td>"; echo $_SESSION['ItemNo--4'][$x]; echo "</td>";
